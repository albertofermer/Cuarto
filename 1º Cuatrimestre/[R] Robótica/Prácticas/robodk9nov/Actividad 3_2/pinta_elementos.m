...
% gama = 0;
% 
% matriz_pieza = Desplazamiento(posicion(1), posicion(2), posicion(3))*Rotacionx(alfa)*Rotaciony(beta)*Rotacionz(gama);
% 
% matriz_pinza = matriz_pieza * matriz_agarre;
% 
% pinta_bloque(matriz_pieza,'b')
...
pinta_bloque(Desplazamiento(5,0,5)*matriz_pieza,'b')
[q1 q2 q3 q4 q5 q6] = inv_kinema_ur3_new(Desplazamiento(5,0,5)*matriz_pinza, codo, avance, simetrico)
