====================================================================================
*													     *
*		Implementación del Algoritmo: ELIMINACIÓN DE CANDIDATOS		     *
*													     *
...
2. Situarse en el directorio donde se encuentra el fichero 
   "EliminacionDeCandidatos.jar"
3. Escribir en la línea de comandos: 
------------------------------------------------------------------------------------
	java -jar EliminacionDeCandidatos.jar <Ruta del Dataset> [Clase Positiva]
------------------------------------------------------------------------------------
...
java -jar EliminacionDeCandidatos.jar .\..\Datasets\Dataset-Tenis.csv
java -jar EliminacionDeCandidatos.jar .\..\Datasets\Dataset-Logica.csv 1
java -jar EliminacionDeCandidatos.jar .\..\Datasets\Dataset-Animales.csv -
