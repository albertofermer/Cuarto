...
# CHC
ALPHA = 0.05
ALPHA_EXP = [0.001, 0.01, 0.05, 0.075, 0.1, 0.2]
NUM_ITERACIONES_CHC = 300
ITERACIONESCHC_EXP = [100, 200, 300, 500, 1000, 1500, 2000]

# Multimodal
POB_INICIAL_MULTIMODAL = 29
MUTACION_MULTIMODAL = 0.2
NUMERO_GENERACIONES_CLEARING = 10
NUMGENCLEARING_EXP = [10, 20, 50, 100, 150, 200, 300]
RADIO_CLEARING = 100
RADIOCLEARING_EXP = [10, 20, 50, 80, 100, 150, 200]
KAPPA = 2
KAPPA_EXP = [2, 4, 6, 8, 10]
